...
tinymce.init({
    ...
    toolbar: ['bold italic link bullist numlist blockquote emoticons other', t_external_toolbar.join(' ')],
    toolbar_groups: { //按钮分组，节省空间，方便使用
        other: {
            icon: 'more-drawer',
            tooltip: '更多按钮',
            items: 'strikethrough aligncenter alignright | image media removeformat | fullscreen'
        }
    },
